...
-- Дамп данных таблицы yii2.access: ~2 rows (приблизительно)
...
-- Дамп данных таблицы yii2.event: ~7 rows (приблизительно)
...
INSERT INTO `event` (`id`, `text`, `dt`, `creator_id`, `created_at`) VALUES
	...
	(16, 'event_5', '0000-00-00 00:00:00', 54, NULL),
	(17, 'event_6', '0000-00-00 00:00:00', 5, NULL),
	(18, 'event_7', '0000-00-00 00:00:00', 1, NULL),
	(20, 'event_8', '0000-00-00 00:00:00', 5, 1530173473),
	(21, 'event_9', '0000-00-00 00:00:00', 5, 1530256969);
...
-- Дамп данных таблицы yii2.migration: ~4 rows (приблизительно)
...
-- Дамп данных таблицы yii2.user: ~6 rows (приблизительно)
...
INSERT INTO `user` (`id`, `username`, `name`, `surname`, `password_hash`, `access_token`, `auth_key`, `created_at`, `updated_at`) VALUES
	...
	(5, 'user_5', 'Илья', '', '$2y$13$UKIsgT/pT/4nn8JSpTyAfOy/5NFXl.1KuBTwi.9k9LBPL5fD7lJy.', '', '', NULL, NULL),
	(54, 'user_6', 'Василий', NULL, 'm7n6b5v4c3x2z1', NULL, NULL, 1530017766, 1530017766),
	(57, 'user_7', 'Дмитрий', 'К.', '$2y$13$1UbE1UgUx5OQ4xgI.ys/A.wdKAkAWbrv/OxfpMYit.cHdCDYAMJpm', NULL, 'RGlyIm6CcuXip3d0_6yxP5saJ0OXtXMY', 1530024559, 1530024559);
